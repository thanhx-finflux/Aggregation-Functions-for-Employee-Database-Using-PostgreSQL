...
-- 3.4: How many different first name can be found in the employees table
...
-- Extract a list of all names that have encountered more than 10 times. Let the data refer to people hired after 1st of January, 1990
...
-- Select the employees numbers of all individuals who have signed more than 1 contract after the 1st of January, 2000
...
-- What is the total number of records in the salaries table?
...
-- Finding the difference between highest and lowest average salary
